...
/* Quantity: generated by netocc-gen from OCCT 8.0.1. Don't edit; change the generator or its config. */
%module QuantityModule
...
%occt_valuetype(Quantity_Color)
%occt_valuetype(Quantity_ColorRGBA)
%occt_valueclass(Quantity_Date)
%occt_valueclass(Quantity_DateDefinitionError)
%occt_valueclass(Quantity_Period)
%nodefaultctor Quantity_Period;
%feature("valuewrapper") Quantity_Period;
%occt_valueclass(Quantity_PeriodDefinitionError)

%{
// Layout guards for the C# structs in src/NetOcc/Quantity/: a mismatch fails the native build.
static_assert(sizeof(Quantity_Color) == 12 && alignof(Quantity_Color) == 4 && std::is_trivially_copyable<Quantity_Color>::value, "Quantity_Color layout");
static_assert(sizeof(Quantity_ColorRGBA) == 16 && alignof(Quantity_ColorRGBA) == 4 && std::is_trivially_copyable<Quantity_ColorRGBA>::value, "Quantity_ColorRGBA layout");
%}

%inline %{
// sizes for the managed layout tests
inline int NetOcc_SizeOf_Quantity_Color() { return (int)sizeof(Quantity_Color); }
inline int NetOcc_SizeOf_Quantity_ColorRGBA() { return (int)sizeof(Quantity_ColorRGBA); }
%}
...
%occt_array1_blittable(Quantity_Array1OfColor, Quantity_Color, Quantity_Color)
%occt_harray1(Quantity_HArray1OfColor, Quantity_Color, Quantity_Color)

class Quantity_Date {
public:
  Quantity_Date();
  Quantity_Date(int mm, int dd, int yyyy, int hh, int mn, int ss, int mis = 0, int mics = 0);
  void Values(int& mm, int& dd, int& yy, int& hh, int& mn, int& ss, int& mis, int& mics) const;
  void SetValues(int mm, int dd, int yy, int hh, int mn, int ss, int mis = 0, int mics = 0);
  ...
  int MilliSecond();
  int MicroSecond();
  bool IsEqual(const Quantity_Date& anOther) const;
  bool IsEarlier(const Quantity_Date& anOther) const;
  bool IsLater(const Quantity_Date& anOther) const;
  static bool IsValid(int mm, int dd, int yy, int hh, int mn, int ss, int mis = 0, int mics = 0);
  static bool IsLeap(int yy);
};

class Quantity_DateDefinitionError : public Standard_DomainError {
public:
  Quantity_DateDefinitionError(const char* theMessage = "");
  Quantity_DateDefinitionError(const char* theMessage, const char* theStackTrace);
  const char* ExceptionType() const;
};

class Quantity_Period {
public:
  Quantity_Period(int dd, int hh, int mn, int ss, int mis = 0, int mics = 0);
  Quantity_Period(int ss, int mics = 0);
  void Values(int& dd, int& hh, int& mn, int& ss, int& mis, int& mics) const;
  void Values(int& ss, int& mics) const;
  void SetValues(int dd, int hh, int mn, int ss, int mis = 0, int mics = 0);
  void SetValues(int ss, int mics = 0);
  Quantity_Period Subtract(const Quantity_Period& anOther) const;
  Quantity_Period Add(const Quantity_Period& anOther) const;
  bool IsEqual(const Quantity_Period& anOther) const;
  bool IsShorter(const Quantity_Period& anOther) const;
  bool IsLonger(const Quantity_Period& anOther) const;
  static bool IsValid(int dd, int hh, int mn, int ss, int mis = 0, int mics = 0);
  static bool IsValid(int ss, int mics = 0);
};

class Quantity_PeriodDefinitionError : public Standard_DomainError {
public:
  Quantity_PeriodDefinitionError(const char* theMessage = "");
  Quantity_PeriodDefinitionError(const char* theMessage, const char* theStackTrace);
  const char* ExceptionType() const;
};

// the native members of the C# structs (src/NetOcc/Quantity/*.g.cs)
%inline %{
inline void NetOcc_Quantity_Color_New_0(Quantity_Color& theSelf) { theSelf = Quantity_Color(); }
inline void NetOcc_Quantity_Color_New_1(Quantity_Color& theSelf, Quantity_NameOfColor theName) { theSelf = Quantity_Color(theName); }
inline void NetOcc_Quantity_Color_New_2(Quantity_Color& theSelf, double theC1, double theC2, double theC3, Quantity_TypeOfColor theType) { theSelf = Quantity_Color(theC1, theC2, theC3, theType); }
inline void NetOcc_Quantity_Color_New_3(Quantity_Color& theSelf, const BVH_Vec3f& theRgb) { theSelf = Quantity_Color(theRgb); }
inline Quantity_NameOfColor NetOcc_Quantity_Color_Name_0(const Quantity_Color& theSelf) { return theSelf.Name(); }
inline Quantity_NameOfColor NetOcc_Quantity_Color_Name_1(double theR, double theG, double theB) { return Quantity_Color::Name(theR, theG, theB); }
inline void NetOcc_Quantity_Color_SetValues_0(Quantity_Color& theSelf, Quantity_NameOfColor theName) { theSelf.SetValues(theName); }
inline void NetOcc_Quantity_Color_SetValues_1(Quantity_Color& theSelf, double theC1, double theC2, double theC3, Quantity_TypeOfColor theType) { theSelf.SetValues(theC1, theC2, theC3, theType); }
inline const BVH_Vec3f& NetOcc_Quantity_Color_Rgb(const Quantity_Color& theSelf) { return theSelf.Rgb(); }
...
inline double NetOcc_Quantity_Color_Hue(const Quantity_Color& theSelf) { return theSelf.Hue(); }
inline double NetOcc_Quantity_Color_Light(const Quantity_Color& theSelf) { return theSelf.Light(); }
inline void NetOcc_Quantity_Color_ChangeIntensity(Quantity_Color& theSelf, double theDelta) { theSelf.ChangeIntensity(theDelta); }
inline double NetOcc_Quantity_Color_Saturation(const Quantity_Color& theSelf) { return theSelf.Saturation(); }
inline void NetOcc_Quantity_Color_ChangeContrast(Quantity_Color& theSelf, double theDelta) { theSelf.ChangeContrast(theDelta); }
inline bool NetOcc_Quantity_Color_IsDifferent(const Quantity_Color& theSelf, const Quantity_Color& theOther) { return theSelf.IsDifferent(theOther); }
...
inline void NetOcc_Quantity_Color_Delta(const Quantity_Color& theSelf, const Quantity_Color& theColor, double& DC, double& DI) { theSelf.Delta(theColor, DC, DI); }
inline double NetOcc_Quantity_Color_DeltaE2000(const Quantity_Color& theSelf, const Quantity_Color& theOther) { return theSelf.DeltaE2000(theOther); }
inline const char* NetOcc_Quantity_Color_StringName(Quantity_NameOfColor theColor) { return Quantity_Color::StringName(theColor); }
inline bool NetOcc_Quantity_Color_ColorFromName_0(const char* theName, Quantity_NameOfColor& theColor) { return Quantity_Color::ColorFromName(theName, theColor); }
inline bool NetOcc_Quantity_Color_ColorFromName_1(const char* theColorNameString, Quantity_Color& theColor) { return Quantity_Color::ColorFromName(theColorNameString, theColor); }
inline bool NetOcc_Quantity_Color_ColorFromHex(const char* theHexColorString, Quantity_Color& theColor) { return Quantity_Color::ColorFromHex(theHexColorString, theColor); }
inline TCollection_AsciiString NetOcc_Quantity_Color_ColorToHex(const Quantity_Color& theColor, bool theToPrefixHash = true) { return Quantity_Color::ColorToHex(theColor, theToPrefixHash); }
inline BVH_Vec3f NetOcc_Quantity_Color_Convert_sRGB_To_HLS(const BVH_Vec3f& theRgb) { return Quantity_Color::Convert_sRGB_To_HLS(theRgb); }
inline BVH_Vec3f NetOcc_Quantity_Color_Convert_HLS_To_sRGB(const BVH_Vec3f& theHls) { return Quantity_Color::Convert_HLS_To_sRGB(theHls); }
inline BVH_Vec3f NetOcc_Quantity_Color_Convert_LinearRGB_To_HLS(const BVH_Vec3f& theRgb) { return Quantity_Color::Convert_LinearRGB_To_HLS(theRgb); }
inline BVH_Vec3f NetOcc_Quantity_Color_Convert_HLS_To_LinearRGB(const BVH_Vec3f& theHls) { return Quantity_Color::Convert_HLS_To_LinearRGB(theHls); }
inline BVH_Vec3f NetOcc_Quantity_Color_Convert_LinearRGB_To_Lab(const BVH_Vec3f& theRgb) { return Quantity_Color::Convert_LinearRGB_To_Lab(theRgb); }
inline BVH_Vec3f NetOcc_Quantity_Color_Convert_Lab_To_Lch(const BVH_Vec3f& theLab) { return Quantity_Color::Convert_Lab_To_Lch(theLab); }
inline BVH_Vec3f NetOcc_Quantity_Color_Convert_Lab_To_LinearRGB(const BVH_Vec3f& theLab) { return Quantity_Color::Convert_Lab_To_LinearRGB(theLab); }
inline BVH_Vec3f NetOcc_Quantity_Color_Convert_Lch_To_Lab(const BVH_Vec3f& theLch) { return Quantity_Color::Convert_Lch_To_Lab(theLch); }
inline void NetOcc_Quantity_Color_Color2argb(const Quantity_Color& theColor, int& theARGB) { Quantity_Color::Color2argb(theColor, theARGB); }
inline void NetOcc_Quantity_Color_Argb2color(int theARGB, Quantity_Color& theColor) { Quantity_Color::Argb2color(theARGB, theColor); }
inline double NetOcc_Quantity_Color_Convert_LinearRGB_To_sRGB_0(double theLinearValue) { return Quantity_Color::Convert_LinearRGB_To_sRGB(theLinearValue); }
inline float NetOcc_Quantity_Color_Convert_LinearRGB_To_sRGB_1(float theLinearValue) { return Quantity_Color::Convert_LinearRGB_To_sRGB(theLinearValue); }
inline double NetOcc_Quantity_Color_Convert_sRGB_To_LinearRGB_0(double thesRGBValue) { return Quantity_Color::Convert_sRGB_To_LinearRGB(thesRGBValue); }
inline float NetOcc_Quantity_Color_Convert_sRGB_To_LinearRGB_1(float thesRGBValue) { return Quantity_Color::Convert_sRGB_To_LinearRGB(thesRGBValue); }
inline float NetOcc_Quantity_Color_Convert_LinearRGB_To_sRGB_approx22_0(float theLinearValue) { return Quantity_Color::Convert_LinearRGB_To_sRGB_approx22(theLinearValue); }
inline BVH_Vec3f NetOcc_Quantity_Color_Convert_LinearRGB_To_sRGB_approx22_1(const BVH_Vec3f& theRGB) { return Quantity_Color::Convert_LinearRGB_To_sRGB_approx22(theRGB); }
inline float NetOcc_Quantity_Color_Convert_sRGB_To_LinearRGB_approx22_0(float thesRGBValue) { return Quantity_Color::Convert_sRGB_To_LinearRGB_approx22(thesRGBValue); }
inline BVH_Vec3f NetOcc_Quantity_Color_Convert_sRGB_To_LinearRGB_approx22_1(const BVH_Vec3f& theRGB) { return Quantity_Color::Convert_sRGB_To_LinearRGB_approx22(theRGB); }
inline void NetOcc_Quantity_Color_HlsRgb(double theH, double theL, double theS, double& theR, double& theG, double& theB) { Quantity_Color::HlsRgb(theH, theL, theS, theR, theG, theB); }
inline void NetOcc_Quantity_Color_RgbHls(double theR, double theG, double theB, double& theH, double& theL, double& theS) { Quantity_Color::RgbHls(theR, theG, theB, theH, theL, theS); }
inline double NetOcc_Quantity_Color_Epsilon() { return Quantity_Color::Epsilon(); }
inline void NetOcc_Quantity_Color_SetEpsilon(double theEpsilon) { Quantity_Color::SetEpsilon(theEpsilon); }
inline void NetOcc_Quantity_Color_DumpJson(const Quantity_Color& theSelf, std::ostream& theOStream, int theDepth = -1) { theSelf.DumpJson(theOStream, theDepth); }
inline bool NetOcc_Quantity_Color_InitFromJson(Quantity_Color& theSelf, const std::stringstream& theSStream, int& theStreamPos) { return theSelf.InitFromJson(theSStream, theStreamPos); }
inline void NetOcc_Quantity_ColorRGBA_New_0(Quantity_ColorRGBA& theSelf) { theSelf = Quantity_ColorRGBA(); }
inline void NetOcc_Quantity_ColorRGBA_New_1(Quantity_ColorRGBA& theSelf, const Quantity_Color& theRgb) { theSelf = Quantity_ColorRGBA(theRgb); }
inline void NetOcc_Quantity_ColorRGBA_New_2(Quantity_ColorRGBA& theSelf, const Quantity_Color& theRgb, float theAlpha) { theSelf = Quantity_ColorRGBA(theRgb, theAlpha); }
inline void NetOcc_Quantity_ColorRGBA_New_3(Quantity_ColorRGBA& theSelf, const BVH_Vec4f& theRgba) { theSelf = Quantity_ColorRGBA(theRgba); }
inline void NetOcc_Quantity_ColorRGBA_New_4(Quantity_ColorRGBA& theSelf, float theRed, float theGreen, float theBlue, float theAlpha) { theSelf = Quantity_ColorRGBA(theRed, theGreen, theBlue, theAlpha); }
inline void NetOcc_Quantity_ColorRGBA_SetValues(Quantity_ColorRGBA& theSelf, float theRed, float theGreen, float theBlue, float theAlpha) { theSelf.SetValues(theRed, theGreen, theBlue, theAlpha); }
inline const Quantity_Color& NetOcc_Quantity_ColorRGBA_GetRGB(const Quantity_ColorRGBA& theSelf) { return theSelf.GetRGB(); }
inline void NetOcc_Quantity_ColorRGBA_SetRGB(Quantity_ColorRGBA& theSelf, const Quantity_Color& theRgb) { theSelf.SetRGB(theRgb); }
inline float NetOcc_Quantity_ColorRGBA_Alpha(const Quantity_ColorRGBA& theSelf) { return theSelf.Alpha(); }
inline void NetOcc_Quantity_ColorRGBA_SetAlpha(Quantity_ColorRGBA& theSelf, float theAlpha) { theSelf.SetAlpha(theAlpha); }
inline bool NetOcc_Quantity_ColorRGBA_IsDifferent(const Quantity_ColorRGBA& theSelf, const Quantity_ColorRGBA& theOther) { return theSelf.IsDifferent(theOther); }
inline bool NetOcc_Quantity_ColorRGBA_IsEqual(const Quantity_ColorRGBA& theSelf, const Quantity_ColorRGBA& theOther) { return theSelf.IsEqual(theOther); }
inline bool NetOcc_Quantity_ColorRGBA_ColorFromName(const char* theColorNameString, Quantity_ColorRGBA& theColor) { return Quantity_ColorRGBA::ColorFromName(theColorNameString, theColor); }
inline bool NetOcc_Quantity_ColorRGBA_ColorFromHex(const char* theHexColorString, Quantity_ColorRGBA& theColor, bool theAlphaComponentIsOff = false) { return Quantity_ColorRGBA::ColorFromHex(theHexColorString, theColor, theAlphaComponentIsOff); }
inline TCollection_AsciiString NetOcc_Quantity_ColorRGBA_ColorToHex(const Quantity_ColorRGBA& theColor, bool theToPrefixHash = true) { return Quantity_ColorRGBA::ColorToHex(theColor, theToPrefixHash); }
inline BVH_Vec4f NetOcc_Quantity_ColorRGBA_Convert_LinearRGB_To_sRGB(const BVH_Vec4f& theRGB) { return Quantity_ColorRGBA::Convert_LinearRGB_To_sRGB(theRGB); }
inline BVH_Vec4f NetOcc_Quantity_ColorRGBA_Convert_sRGB_To_LinearRGB(const BVH_Vec4f& theRGB) { return Quantity_ColorRGBA::Convert_sRGB_To_LinearRGB(theRGB); }
inline void NetOcc_Quantity_ColorRGBA_DumpJson(const Quantity_ColorRGBA& theSelf, std::ostream& theOStream, int theDepth = -1) { theSelf.DumpJson(theOStream, theDepth); }
inline bool NetOcc_Quantity_ColorRGBA_InitFromJson(Quantity_ColorRGBA& theSelf, const std::stringstream& theSStream, int& theStreamPos) { return theSelf.InitFromJson(theSStream, theStreamPos); }
%}
