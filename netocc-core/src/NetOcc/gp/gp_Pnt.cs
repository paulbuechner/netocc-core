...
/// <summary>OCCT <c>gp_Pnt</c>: a 3D point. Managed math; the layout and the native members are in gp_Pnt.g.cs.</summary>
public partial struct gp_Pnt : IEquatable<gp_Pnt>
{
    public gp_Pnt()
    {
    }
