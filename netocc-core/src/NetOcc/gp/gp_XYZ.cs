...
/// <summary>OCCT <c>gp_XYZ</c>: three doubles. Managed math; the layout and the native members are in gp_XYZ.g.cs.</summary>
public partial struct gp_XYZ : IEquatable<gp_XYZ>
{
    public gp_XYZ()
    {
    }

    public gp_XYZ(double theX, double theY, double theZ)
    {
        x = theX;
        y = theY;
        z = theZ;
