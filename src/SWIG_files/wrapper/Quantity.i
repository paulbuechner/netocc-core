...
%occt_valueclass(Quantity_ColorRGBA)
...
public:
  ...
  static bool ColorFromName(const char* theColorNameString, Quantity_ColorRGBA& theColor);
  static bool ColorFromHex(const char* theHexColorString, Quantity_ColorRGBA& theColor, bool theAlphaComponentIsOff = false);
  static TCollection_AsciiString ColorToHex(const Quantity_ColorRGBA& theColor, bool theToPrefixHash = true);
};
