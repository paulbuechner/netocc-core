...
/// <summary>OCCT <c>gp_Vec</c>: a 3D vector, same layout as C++.</summary>
[StructLayout(LayoutKind.Explicit, Size = 24)]
public struct gp_Vec : IEquatable<gp_Vec>
{
    ...
    // Standard_ConstructionError for a null vector, like OCCT
