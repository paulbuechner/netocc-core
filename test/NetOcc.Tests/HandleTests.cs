...
/// <summary>Transient objects: each proxy owns one reference; Handle(T)::DownCast maps to T.DownCast.</summary>
[TestFixture]
public class HandleTests
{
    ...
    public void DownCast_FindsTheConcreteSurface()
    {
        ...
        {
            Assert.That(surface.DynamicTypeName(), Is.EqualTo("Geom_Plane"));
